...
@AcraMailSender(mailTo = MyApplication.EMAIL_TO)
@AcraCore(buildConfigClass = BuildConfig.class)
public class MyApplication extends Application {
    public static final String EMAIL_TO= "email@provider.bla";//replace this value with your own(owner of the app) email id
